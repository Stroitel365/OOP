package sem_6_hw.service;

import sem_6_hw.data.Student;
import sem_6_hw.data.UserComparator;
...
В нашшем коде сервисы StudentService и TeacherService используют UserService, 
а StudentGroupService нет, потому что здесь не создаются никакие юзеры.
